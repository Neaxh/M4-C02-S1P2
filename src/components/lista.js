...
function agregarIds(peliculas) {
    return peliculas.map((item, index) => {
        return {
            id: index + 1, // Asigna un ID único (comenzando desde 1)
            ...item // Copia todas las propiedades originales del objeto
        };
    });
}

// Lista de películas con IDs
const peliculasConIds = agregarIds(peliculas);
console.log(peliculasConIds);